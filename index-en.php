                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Continuous technical and operational support, infrastructure
                                    management.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Development and customization of Odoo and Microsoft Dynamics,
                                    system integration, and connectivity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Advanced websites, UI/UX design, and comprehensive visual identity
                                    creation.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Building and operating platforms, developing electronic systems,
                                    and business solutions.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Surveillance and access control systems, AI-powered specialized
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Solutions for smart meetings, interactive presentations, and
                                    event/exhibition halls.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Big data, business intelligence, dashboards, data integration, and
                                    analytics.</p>
                            </div>
                        </div>
                    </div>
