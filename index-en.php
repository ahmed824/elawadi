    ...
    <main>
        ...
        <section id="hero" class="hero d-flex align-items-center justify-content-center">
            <div class="container text-center w-100">
                ...
                <h3 class="w-50 m-auto">A leading Saudi company providing comprehensive technology solutions, focusing
                    on enabling digital
                    transformation, cybersecurity, and system services for government and major private sector entities
                </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex flex-column about-us-text mt-5 mt-lg-0">
                        ...
                        <p class="about-us-description">
                            Alwadi International is a leading Saudi company providing comprehensive technology
                            solutions, focusing on enabling digital transformation, cybersecurity, and system services
                            for government and major private sector entities.
                        </p>
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Digital Transformation and Process Structuring</h5>
                                <p class="card-text">Development of technical guides, process re-engineering, and
                                    optimization.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Cybersecurity and Advanced Protection</h5>
                                <p class="card-text">Compliance with National Cybersecurity Authority standards,
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Managed Services and Technical Support</h5>
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">ERP System Development and Customization</h5>
                                <p class="card-text">Continuous technical and operational support, infrastructure
                                    management.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Cloud System Performance Optimization</h5>
                                <p class="card-text">Data migration and management, cloud performance enhancement.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Website, Application, and Identity Design</h5>
                                <p class="card-text">Advanced websites, UI/UX design, comprehensive visual identity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Digital Platform Creation and Operation</h5>
                                <p class="card-text">Platform creation and operation, electronic system development, and
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Technical Consulting and Support</h5>
                                <p class="card-text">Data migration and management, cloud performance enhancement.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Cameras and Security Systems</h5>
                                <p class="card-text">Advanced websites, UI/UX design, comprehensive visual identity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Smart Room Setup and Equipping</h5>
                                <p class="card-text">Windows / Office / Oracle / Adobe and more.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Business Intelligence and Data Warehousing</h5>
                                <p class="card-text">Platform creation and operation, electronic system development, and
                                    business solutions.</p>
                            </div>
                        </div>
