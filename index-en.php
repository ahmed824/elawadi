...
<body>
    ...
    <header class="header fixed-top">
        <nav class="navbar navbar-expand-lg flex-row-reverse d-none d-lg-flex">
            <div class="container">
                <!-- Desktop Navbar -->
                <ul class="navbar-nav m-auto">
                    ...
                    <div class="blur-bg">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#locations">Our Locations</a></li>
        ...
        <div class="side-nav d-lg-none" id="sideNav">
            ...
            <div class="side-nav-header d-flex  align-items-center justify-content-between">
                <img class="logo" src="./assets/Logo.svg" alt="logo">
                <button class="close-side-nav" id="closeSideNav" aria-label="Close Menu">
            ...
            <ul class="side-nav-links">
                ...
                <li><button id="lang-toggle-mobile" class="btn nav-link">AR <svg class="lang-svg me-1" width="13"
        ...
        <button class="side-nav-toggler d-lg-none" id="openSideNav" aria-label="Open Menu">
    ...
    <main>
        ...
        <section id="hero" class="hero d-flex align-items-center justify-content-center">
            <div class="container text-center w-100">
                ...
                <h2>Connecting Technology with the World, Building the Future</h2>
                <h3 class="w-50 m-auto">To enable our customers to achieve operational excellence and sustainable growth
                    through our local and international experts and partners.
                </h3>
                <div class="hero-buttons mt-4 d-flex justify-content-center gap-3">
                    <a href="#contact" class="btn hero-btn-contact">Contact Us</a>
                    <a href="#services" class="btn hero-btn-services">Discover Our Services</a>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-us-container">
                            <img src="./assets/about-us.jpg" class="about-us-img" alt="About Us" />
                    ...
                    <div class="col-lg-6 d-flex flex-column about-us-text mt-5 mt-lg-0">
                        <h2 class="about-us-title">
                            Comprehensive Technology Solutions <br class="d-none d-md-block"> for Government and Private
                            Sectors
                        </h2>
                        <p class="about-us-description">
                            International Valley is a leading Saudi company delivering comprehensive technology
                            solutions, specializing in empowering digital transformation, cybersecurity, and system
                            services for government entities and major private sector organizations.
                        </p>
                        <div class="about-us-mission-vision d-flex gap-3 mt-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">To be the leading technology partner in the Kingdom and the
                                        region, enabling comprehensive digital transformation and building a sustainable
                                        future through innovation and digital advancement.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">We provide comprehensive technology and investment solutions,
                                        focusing on digital transformation and cybersecurity, to empower our clients to
                                        excel and achieve sustainable growth through our expertise and partnerships.</p>
                                </div>
                            </div>
                        </div>
                        <div class="about-us-counters d-flex justify-content-around section-fade text-center mt-5">
                            <div class="count-card">
                                ...
                                <span class="small">Projects Completed</span>
                            </div>
                            <div class="mid-count count-card">
                                <h4 class="mb-0">+150</h4>
                                <span class="small">Satisfied Clients</span>
                            </div>
                            <div class="count-card">
                                <h4 class="mb-0">2025</h4>
                                <span class="small">Year Founded</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"> Digital Transformation & Process Structuring</h5>
                                <p class="card-text">Developing technical frameworks, re-engineering, and optimizing
                                    processes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Compliance with the National Cybersecurity Authority standards,
                                    vulnerability assessments, and advanced protection.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Continuous technical and operational support, infrastructure management.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Development and customization of Odoo and Microsoft Dynamics, system integration, and connectivity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <p class="card-text">Data migration, management, and cloud performance optimization.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"> Website & Application Design, Branding</h5>
                                <p class="card-text">Advanced websites, UI/UX design, and comprehensive visual identity creation.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Software Licensing</h5>
                                <p class="card-text">Windows / Office / Oracle / Adobe and more.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Digital Platforms</h5>
                                <p class="card-text">Building and operating platforms, developing electronic systems, and business solutions.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"> Technical Consulting & Support</h5>
                                <p class="card-text">Strategic planning and tailored technical support.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Security Cameras & Systems</h5>
                                <p class="card-text">Surveillance and access control systems, AI-powered specialized security solutions.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"> Smart Meeting Rooms</h5>
                                <p class="card-text">Solutions for smart meetings, interactive presentations, and event/exhibition halls.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 mb-4">
                        <div class="card service-card section-fade">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Business Intelligence & Data Warehousing</h5>
                                <p class="card-text">Big data, business intelligence, dashboards, data integration, and analytics.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 mb-5 mb-lg-0 py-5">
                        <div class="swiper-title text-start mb-4">
                            ...
                            <div class="swiper-slide">
                                <div class="news-card section-fade">
                                    ...
                                    <div class="news-card-body">
                                        ...
                                        <h5 class="card-title">The Pivotal Role of Cybersecurity in Enabling Digital
                                            Transformation</h5>
                                        <p class="card-text">How Saudi companies can leverage AI technologies to improve
                                            their operations and increase efficiency.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                        ...
                        <svg class="world-map" viewBox="0 0 1000 500" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <foreignObject x="100" y="140" width="180" height="60">
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                    ...
                                    <span style="font-weight: bold; font-size: 14px; color: #fff;">United States</span>
                                    <span
                                        style="font-size: 12px; background: linear-gradient(232.05deg, #CBA228 28.98%, #EFCA5E 77.99%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-fill-color: transparent; color: unset; margin-top: 2px;">Representative
                                        Office - London</span>
                                </div>
                            </foreignObject>
                            <foreignObject x="480" y="200" width="200" height="70">
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                    style="display: flex; flex-direction: column; align-items: center; justify-content: center; background: #FFFFFF0A; border-radius: 10px; padding: 5px 12px; height: 100%;">
                                    <span style="font-weight: bold; font-size: 14px; color: #fff;">Saudi Arabia</span>
                                    <span
                                        style="font-size: 12px; background: linear-gradient(232.05deg, #CBA228 28.98%, #EFCA5E 77.99%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-fill-color: transparent; color: unset; margin-top: 2px;">Headquarters
                                        - Jeddah</span>
                                </div>
                            </foreignObject>
                            <foreignObject x="640" y="260" width="180" height="60">
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                    style="display: flex; flex-direction: column; align-items: center; justify-content: center; background: #FFFFFF0A; border-radius: 10px; padding: 5px 12px; height: 100%;">
                                    <span style="font-weight: bold; font-size: 14px; color: #fff;">United Arab
                                        Emirates</span>
                                    <span
                                        style="font-size: 12px; background: linear-gradient(232.05deg, #CBA228 28.98%, #EFCA5E 77.99%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-fill-color: transparent; color: unset; margin-top: 2px;">Business
                                        Center - Dubai</span>
                                </div>
                            </foreignObject>
                        </svg>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 yellow-shadow section-fade">
                        <form id="contactForm" onsubmit="handleFormSubmit(event)">
                            <h4 class="mb-4">Please Fill in the Following Details</h4>
    ...
    <section class="contact-info-section">
        <div class="container">
            <div class="d-flex content flex-row justify-content-center align-items-stretch gap-2 py-4">
                ...
                <div class="contact-info-item text-center flex-fill" style="min-width:200px;">
                    ...
                    <div class="contact-label">Private Email</div>
                ...
                <!-- <div class="contact-info-item text-center flex-fill" style="min-width:200px;">
                    ...
                    <div class="contact-link">Hamed Khaled Hamed Azhar</div>
                </div> -->
            </div>
        </div>
    </section>
    ...
    <footer class="text-center">
        <div class="container">
            <img src="./assets/footer-logo.svg" class="footer-logo" alt="Footer Logo">
            <p>A leading Saudi company providing integrated technology solutions, focusing on enabling digital
                transformation, cybersecurity, and system services for government entities and major private sector
                organizations.</p>
        </div>
        <img src="./assets/styles/bottom-style.png" alt="Styles Circles" class="gold-lines-bottom">
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let isEnglish = html.getAttribute('lang') === 'en';
            ...
            langToggle.addEventListener('click', function () {
                ...
                if (!isEnglish) {
                    ...
                    document.head.querySelectorAll('link[rel="stylesheet"]').forEach(link => {
                        link.href = 'style.css'; // load Arabic version if different
                    });
                    window.location.href = 'index.php'; // redirect to Arabic version
                }
            });
        });
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const text = "International Valley Company";
