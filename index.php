...
<body>
    ...
    <header class="header fixed-top">
        ...
        <div class="side-nav d-lg-none" id="sideNav">
            <div class="nav-stars-bg"></div>
            <div class="side-nav-header d-flex align-items-center justify-content-between">
                <img class="logo" src="./assets/Logo.svg" alt="logo">
                <button class="close-side-nav" id="closeSideNav" aria-label="إغلاق القائمة">
            ...
            <ul class="side-nav-links">
                ...
                <li><a href="#news">المدونة</a></li>
                <li><a href="#locations">أماكن تواجدنا</a></li>
                <li><a href="#contact">تواصل معنا</a></li>
                <li><button id="lang-toggle-mobile" class="btn nav-link">EN <svg class="lang-svg me-1" width="13"
                            height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path ... />
                        </svg></button></li>
            </ul>
        </div>
        <div class="side-nav-overlay d-lg-none" id="sideNavOverlay"></div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6 section-title text-center mb-5 mt-4 mt-lg-0 ">
                        ...
                        <div class="social-media-container">
                            ...
                            <a href="https://x.com/" target="_blank" class="social-icon icon-x"
                                aria-label="X (Twitter)">
                                <i class="fab fa-x-twitter"></i>
                            </a>
                            <a href="https://facebook.com/" target="_blank" class="social-icon icon-facebook"
                                aria-label="Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="https://wa.me/966XXXXXXXXX" target="_blank" class="social-icon icon-whatsapp"
                                aria-label="WhatsApp">
